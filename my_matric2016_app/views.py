...
#get number of students who wrote and those who passed, given 'year' and 'province'
    ...
    body = "<body><div style = 'width:40%;height:40%'><canvas id = 'chart2014'></canvas></div><br><div style = 'width:40%;height:40%'><canvas id = 'pass_rate_2014'></canvas></div><br><div style = 'width:40%;height:40%'><canvas id = 'chart2015'></canvas></div><br><div style = 'width:40%;height:40%'><canvas id = 'pass_rate_2015'></canvas></div><br><div style = 'width:40%;height:40%'><canvas id = 'chart2016'></canvas></div><br><div style = 'width:40%;height:40%'><canvas id = 'pass_rate_2016'></canvas></div><script>"
    data1="var myChart = document.getElementById('chart2014').getContext('2d');var barChart = new Chart(myChart, {type: 'bar',data:{labels:['EC','WC','KZ','LP','NC','NW','FS','MP','GP'],datasets:[{label:'Wrote',data:["+str(num_wrote(getData('2014','EC')))+","+str(num_wrote(getData('2014','WC')))+","+str(num_wrote(getData('2014','KZ')))+","+str(num_wrote(getData('2014','LP')))+","+str(num_wrote(getData('2014','NC')))+","+str(num_wrote(getData('2014','NW')))+","+str(num_wrote(getData('2014','FS')))+","+str(num_wrote(getData('2014','MP')))+","+str(num_wrote(getData('2014','GP')))+"],backgroundColor:'black',},{label:'Passed',data:[60,70,52,81,69,49,43,58,49],backgroundColor:'green'},]},options:{scales:{xAxes:[{scaleLabel:{display:true,labelString: 'Provinces'}}],yAxes:[{scaleLabel:{display:true,labelString: 'Number of Students'}}]}}})"
    data2="var myChart = document.getElementById('pass_rate_2014').getContext('2d');var barChart = new Chart(myChart, {type: 'bar',data:{labels:['EC','WC','KZ','LP','NC','NW','FS','MP','GP'],datasets:[{label:'Wrote',data:["+str(num_wrote(getData('2014','EC')))+","+str(num_wrote(getData('2014','WC')))+","+str(num_wrote(getData('2014','KZ')))+","+str(num_wrote(getData('2014','LP')))+","+str(num_wrote(getData('2014','NC')))+","+str(num_wrote(getData('2014','NW')))+","+str(num_wrote(getData('2014','FS')))+","+str(num_wrote(getData('2014','MP')))+","+str(num_wrote(getData('2014','GP')))+"],backgroundColor:'black',},{label:'Passed',data:[60,70,52,81,69,49,43,58,49],backgroundColor:'green'},]},options:{scales:{xAxes:[{scaleLabel:{display:true,labelString: 'Provinces'}}],yAxes:[{scaleLabel:{display:true,labelString: 'Number of Students'}}]}}})"
    data3="var myChart = document.getElementById('chart2015').getContext('2d');var barChart = new Chart(myChart, {type: 'bar',data:{labels:['EC','WC','KZ','LP','NC','NW','FS','MP','GP'],datasets:[{label:'Wrote',data:["+str(num_wrote(getData('2014','EC')))+","+str(num_wrote(getData('2014','WC')))+","+str(num_wrote(getData('2014','KZ')))+","+str(num_wrote(getData('2014','LP')))+","+str(num_wrote(getData('2014','NC')))+","+str(num_wrote(getData('2014','NW')))+","+str(num_wrote(getData('2014','FS')))+","+str(num_wrote(getData('2014','MP')))+","+str(num_wrote(getData('2014','GP')))+"],backgroundColor:'black',},{label:'Passed',data:[60,70,52,81,69,49,43,58,49],backgroundColor:'green'},]},options:{scales:{xAxes:[{scaleLabel:{display:true,labelString: 'Provinces'}}],yAxes:[{scaleLabel:{display:true,labelString: 'Number of Students'}}]}}})"
    data4="var myChart = document.getElementById('pass_rate_2015').getContext('2d');var barChart = new Chart(myChart, {type: 'bar',data:{labels:['EC','WC','KZ','LP','NC','NW','FS','MP','GP'],datasets:[{label:'Wrote',data:["+str(num_wrote(getData('2014','EC')))+","+str(num_wrote(getData('2014','WC')))+","+str(num_wrote(getData('2014','KZ')))+","+str(num_wrote(getData('2014','LP')))+","+str(num_wrote(getData('2014','NC')))+","+str(num_wrote(getData('2014','NW')))+","+str(num_wrote(getData('2014','FS')))+","+str(num_wrote(getData('2014','MP')))+","+str(num_wrote(getData('2014','GP')))+"],backgroundColor:'black',},{label:'Passed',data:[60,70,52,81,69,49,43,58,49],backgroundColor:'green'},]},options:{scales:{xAxes:[{scaleLabel:{display:true,labelString: 'Provinces'}}],yAxes:[{scaleLabel:{display:true,labelString: 'Number of Students'}}]}}})"
    data5="var myChart = document.getElementById('chart2016').getContext('2d');var barChart = new Chart(myChart, {type: 'bar',data:{labels:['EC','WC','KZ','LP','NC','NW','FS','MP','GP'],datasets:[{label:'Wrote',data:["+str(num_wrote(getData('2014','EC')))+","+str(num_wrote(getData('2014','WC')))+","+str(num_wrote(getData('2014','KZ')))+","+str(num_wrote(getData('2014','LP')))+","+str(num_wrote(getData('2014','NC')))+","+str(num_wrote(getData('2014','NW')))+","+str(num_wrote(getData('2014','FS')))+","+str(num_wrote(getData('2014','MP')))+","+str(num_wrote(getData('2014','GP')))+"],backgroundColor:'black',},{label:'Passed',data:[60,70,52,81,69,49,43,58,49],backgroundColor:'green'},]},options:{scales:{xAxes:[{scaleLabel:{display:true,labelString: 'Provinces'}}],yAxes:[{scaleLabel:{display:true,labelString: 'Number of Students'}}]}}})"
    data6="var myChart = document.getElementById('pass_rate_2016').getContext('2d');var barChart = new Chart(myChart, {type: 'bar',data:{labels:['EC','WC','KZ','LP','NC','NW','FS','MP','GP'],datasets:[{label:'Wrote',data:["+str(num_wrote(getData('2014','EC')))+","+str(num_wrote(getData('2014','WC')))+","+str(num_wrote(getData('2014','KZ')))+","+str(num_wrote(getData('2014','LP')))+","+str(num_wrote(getData('2014','NC')))+","+str(num_wrote(getData('2014','NW')))+","+str(num_wrote(getData('2014','FS')))+","+str(num_wrote(getData('2014','MP')))+","+str(num_wrote(getData('2014','GP')))+"],backgroundColor:'black',},{label:'Passed',data:[60,70,52,81,69,49,43,58,49],backgroundColor:'green'},]},options:{scales:{xAxes:[{scaleLabel:{display:true,labelString: 'Provinces'}}],yAxes:[{scaleLabel:{display:true,labelString: 'Number of Students'}}]}}})"
	
    end = "</script></body></html>"
	
    content = head+body+data1+data2+data3+data4+data5+data6+end
